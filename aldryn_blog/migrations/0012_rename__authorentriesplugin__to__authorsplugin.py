...
class Migration(DataMigration):
    ...
    models = {
        ...
        u'aldryn_blog.post': {
            ...
            'author': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['myauth.User']"}),
        ...
        'cms.globalpagepermission': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['myauth.User']", 'null': 'True', 'blank': 'True'})
        },
        'cms.page': {
        ...
        'cms.pagemoderatorstate': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['myauth.User']", 'null': 'True'})
        },
        'cms.pagepermission': {
        ...
        'cms.pageuser': {
            'Meta': {'object_name': 'PageUser', '_ormbases': [u'myauth.User']},
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'created_users'", 'to': u"orm['myauth.User']"}),
            u'user_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['myauth.User']", 'unique': 'True', 'primary_key': 'True'})
        },
        'cms.pageusergroup': {
            'Meta': {'object_name': 'PageUserGroup', '_ormbases': [u'auth.Group']},
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'created_usergroups'", 'to': u"orm['myauth.User']"}),
        ...
        'cms.usersettings': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'djangocms_usersettings'", 'to': u"orm['myauth.User']"})
        },
        ...
        'filer.file': {
            ...
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'owned_files'", 'null': 'True', 'to': u"orm['myauth.User']"}),
        ...
        'filer.folder': {
            ...
            'modified_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'filer_owned_folders'", 'null': 'True', 'to': u"orm['myauth.User']"}),
